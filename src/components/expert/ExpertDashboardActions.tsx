    ...
    <div className="bg-white dark:bg-slate-900 p-8 rounded-[40px] border border-slate-100 dark:border-slate-800 shadow-sm">
      ...
      <div className="space-y-4">
        {[
          ...
          { href: "/expert/calendar", label: "Clinical Calendar", icon: Calendar, color: "text-orange-600 dark:text-orange-400", bg: "bg-orange-500/5 hover:bg-orange-500/10", border: "border-orange-500/10 hover:border-orange-500/30" },
